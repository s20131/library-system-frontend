const HomePage = () => {
  return (
    <>
      <h1>Witaj na stronie systemu bibliotecznego!</h1>
      <p>
        ...
        ornare orci. In venenatis justo et lorem malesuada interdum. Nunc lorem mauris, finibus eu elementum eu, tempus
